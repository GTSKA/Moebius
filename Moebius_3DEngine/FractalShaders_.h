#pragma once
#ifndef _MOEBIUS3D_FRACTAL_SHADERS_H_
#define	_MOEBIUS3D_FRACTAL_SHADERS_H_

#include "M3D_CommondInclude.h"
#include "Effect_.h"

class CFractalShaders_ : public CEffectBase_
{
public:
	CFractalShaders_(void);
	~CFractalShaders_(void);
};

static const CHAR __SHADER_FRACTALS[] =
	...
	"float CenterX = 0.0;\n"
	"float CenterY = 0.0;\n"
	"float outColorDefinition = 0.3;\n"
	"float JuliaSeedX = -0.032;\n"
	"float JuliaSeedY = -0.73;\n"
